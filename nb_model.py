...
expr = "confirmed_cases ~ cases_of_covid19 + corona + coronavirus + coronavirus_cases + " \
       "coronavirus_covid19 + coronavirus_news + coronavirus_update + covid + covid_19 + " \
       "covid_19_cases + covid19 + covid19_cases"
...
store_predict_points(Y_entire, predicted_Y_entire, 'output/test_nb2_prediction_r2_' + str(r2) + '.csv')
